...
/**
* client port resource information
*/
typedef struct {
    char* ex_intf;
    char* ex_ip;
    unsigned short ex_port_range_idx;
    unsigned short ex_tcp_port_bgn;
    unsigned short ex_tcp_port_end;
    unsigned short ex_udp_port_bgn;
    unsigned short ex_udp_port_end;
}t_client_port_res;
...
typedef struct _t_client {
    ...
    t_client_port_res port_res;         /**< @brief Client external source port begin*/
